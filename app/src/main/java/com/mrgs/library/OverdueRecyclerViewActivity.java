...
public class OverdueRecyclerViewActivity extends RecyclerView.Adapter<OverdueRecyclerViewActivity.myViewHolder> {
    ...
    //Constructor
    public OverdueRecyclerViewActivity(Context context, ArrayList<Integer> bookCover, ArrayList<String> bookName,
    ...
    public static class myViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView nBookType;
        TextView nBookTheme;
        LinearLayout nOverdueRecyclerViewLayout;
        ...
        public myViewHolder (View itemView) {
            ...
            nBookName = itemView.findViewById(R.id.overdue_book_name);
            nBookAuthor = itemView.findViewById(R.id.overdue_book_author);
            nBookYear = itemView.findViewById(R.id.overdue_book_year);
            nBookType = itemView.findViewById(R.id.overdue_book_type);
            nBookTheme = itemView.findViewById(R.id.overdue_book_theme);
            nOverdueRecyclerViewLayout = itemView.findViewById(R.id.overdue_recyclerview_layout);
